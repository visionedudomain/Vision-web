(function () {
  ...
  var translations = {
    en: {
      ...
      admin_workspace_label: "Admin Workspace",
      admin_workspace_overview_title: "Website & Applications",
      admin_workspace_overview_intro: "Manage public content, homepage updates, and admission form submissions.",
      admin_workspace_tests_title: "Test Management",
      admin_workspace_tests_intro: "Handle registrations, student access, retest approvals, test builder, and results in one place.",
      admin_workspace_fees_title: "Fees Management",
      admin_workspace_fees_intro: "Track fee collection, due balances, and payment notes for approved students.",
      admin_view_overview: "Website",
      admin_view_tests: "Test Management",
      admin_view_fees: "Fees Management",
      ...
      label_marquee_upload: "Marquee Image Paths",
      ...
      admin_marquee_upload_hint: "Paste one image path per line, or drop/select image files from assets/images. Save after adding.",
      admin_marquee_drop_title: "Drop marquee images here",
      admin_marquee_drop_text: "or choose image files already added to assets/images",
      admin_marquee_choose_files: "Choose Files",
      ...
      status_marquee_files_added: "Image paths added. Save website information to publish them.",
      status_marquee_files_skipped: "No new image files were added.",
    ...
    ta: {
      ...
      label_marquee_upload: "மார்கி பட பாதைகள்",
      placeholder_marquee_images: "assets/images/photo-1.jpg\nassets/images/photo-2.jpg\nhttps://example.com/photo-3.jpg",
      admin_marquee_hint: "ஒவ்வொரு வரியிலும் ஒரு பட path அல்லது URL கொடுக்கவும். உதாரணம்: assets/images/photo-1.jpg",
      admin_marquee_upload_hint: "ஒவ்வொரு வரியிலும் ஒரு பட path கொடுக்கவும், அல்லது assets/images-ல் உள்ள படங்களை drop/select செய்யவும். சேர்த்த பிறகு save செய்யவும்.",
      admin_marquee_drop_title: "Marquee படங்களை இங்கே drop செய்யவும்",
      admin_marquee_drop_text: "அல்லது assets/images-ல் ஏற்கனவே சேர்த்த image files-ஐ தேர்வு செய்யவும்",
      admin_marquee_choose_files: "Files தேர்வு",
      ...
      status_marquee_files_added: "பட paths சேர்க்கப்பட்டன. வெளியிட website information-ஐ save செய்யவும்.",
      status_marquee_files_skipped: "புதிய image files எதுவும் சேர்க்கப்படவில்லை.",
